...
export const businessFunctions: BusinessFunction[] = [
  {
    ...
    useCasesHref: "/case-studies/tag/Brand/",
  ...
  },
  {
    ...
    useCasesHref: "/case-studies/tag/Operation/",
  ...
  },
  {
    ...
    useCasesHref: "/case-studies/tag/Systems/",
  ...
  },
  {
    ...
    useCasesHref: "/case-studies/tag/Knowledge/",
  ...
  },
  {
    ...
    useCasesHref: "/case-studies/tag/Compliance/",
  ...
  },
  {
    ...
    journey: [
      ...
      },
      {
        ...
        body: "Extend the same operating logic into more teams, systems, and case studies as confidence and capability grow.",
      },
    ],
    useCasesHref: "/case-studies/tag/iBOM/",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes. That is the point. Once you have a reusable knowledge model and a governed runtime layer, the same logic can be extended across more teams, systems, and case studies with greater control.",
      },
      {
